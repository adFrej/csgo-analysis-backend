...
#     bombaction = models.TextField(db_column='bombAction', blank=True, null=True)
#     bombsite = models.CharField(db_column='bombSite', max_length=1, blank=True, null=True)
#     roundnum = models.PositiveSmallIntegerField(db_column='roundNum', blank=True, null=True)
#     matchid = models.ForeignKey('Frame', models.DO_NOTHING, db_column='matchID')
#     tick_parsed = models.ForeignKey('Frame', models.DO_NOTHING, db_column='tick_parsed', blank=True, null=True)
#
#     class Meta:
#         managed = False
#         db_table = 'bombevent'
...
#     hpdamagetaken = models.IntegerField(db_column='hpDamageTaken', blank=True, null=True)
#     armordamage = models.SmallIntegerField(db_column='armorDamage', blank=True, null=True)
#     armordamagetaken = models.IntegerField(db_column='armorDamageTaken', blank=True, null=True)
...
#     matchid = models.ForeignKey('Frame', models.DO_NOTHING, db_column='matchID')
#     tick_parsed = models.ForeignKey('Frame', models.DO_NOTHING, db_column='tick_parsed', blank=True, null=True)
#     id = models.PositiveSmallIntegerField(db_column='ID')
#
#     class Meta:
#         managed = False
...
#     bombsite = models.CharField(max_length=1, blank=True, null=True)
#     clocktime = models.CharField(db_column='clockTime', max_length=5, blank=True, null=True)
#     ctaliveplayers = models.IntegerField(db_column='ctAlivePlayers', blank=True, null=True)
#     cteqval = models.PositiveIntegerField(db_column='ctEqVal', blank=True, null=True)
#     ctname = models.TextField(db_column='ctName', blank=True, null=True)
...
#     ctplayer_1 = models.ForeignKey('Player', models.DO_NOTHING, db_column='ctPlayer_1_ID', blank=True, null=True)
...
#     ctplayer_1_cash = models.PositiveSmallIntegerField(db_column='ctPlayer_1_cash', blank=True, null=True)
#     ctplayer_1_cashspendthisround = models.PositiveSmallIntegerField(db_column='ctPlayer_1_cashSpendThisRound', blank=True, null=True)
#     ctplayer_1_cashspendtotal = models.PositiveIntegerField(db_column='ctPlayer_1_cashSpendTotal', blank=True, null=True)
#     ctplayer_1_equipmentvalue = models.PositiveSmallIntegerField(db_column='ctPlayer_1_equipmentValue', blank=True, null=True)
...
#     ctplayer_1_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='ctPlayer_1_equipmentValueRoundStart', blank=True, null=True)
...
#     ctplayer_1_isinbombzone = Bit1BooleanField(db_column='ctPlayer_1_isInBombZone', blank=True, null=True)
#     ctplayer_1_isinbuyzone = Bit1BooleanField(db_column='ctPlayer_1_isInBuyZone', blank=True, null=True)
...
#     ctplayer_1_isstanding = Bit1BooleanField(db_column='ctPlayer_1_isStanding', blank=True, null=True)
#     ctplayer_1_isunduckinginprogress = Bit1BooleanField(db_column='ctPlayer_1_isUnDuckingInProgress', blank=True, null=True)
#     ctplayer_1_isunknown = Bit1BooleanField(db_column='ctPlayer_1_isUnknown', blank=True, null=True)
#     ctplayer_1_iswalking = Bit1BooleanField(db_column='ctPlayer_1_isWalking', blank=True, null=True)
#     ctplayer_1_lastplacename = models.TextField(db_column='ctPlayer_1_lastPlaceName', blank=True, null=True)
...
#     ctplayer_1_spotters = models.TextField(db_column='ctPlayer_1_spotters', blank=True, null=True)
...
#     ctplayer_2 = models.ForeignKey('Player', models.DO_NOTHING, db_column='ctPlayer_2_ID', blank=True, null=True)
...
#     ctplayer_2_cash = models.PositiveSmallIntegerField(db_column='ctPlayer_2_cash', blank=True, null=True)
#     ctplayer_2_cashspendthisround = models.PositiveSmallIntegerField(db_column='ctPlayer_2_cashSpendThisRound', blank=True, null=True)
#     ctplayer_2_cashspendtotal = models.PositiveIntegerField(db_column='ctPlayer_2_cashSpendTotal', blank=True, null=True)
#     ctplayer_2_equipmentvalue = models.PositiveSmallIntegerField(db_column='ctPlayer_2_equipmentValue', blank=True, null=True)
...
#     ctplayer_2_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='ctPlayer_2_equipmentValueRoundStart', blank=True, null=True)
...
#     ctplayer_2_isinbombzone = Bit1BooleanField(db_column='ctPlayer_2_isInBombZone', blank=True, null=True)
#     ctplayer_2_isinbuyzone = Bit1BooleanField(db_column='ctPlayer_2_isInBuyZone', blank=True, null=True)
...
#     ctplayer_2_isstanding = Bit1BooleanField(db_column='ctPlayer_2_isStanding', blank=True, null=True)
#     ctplayer_2_isunduckinginprogress = Bit1BooleanField(db_column='ctPlayer_2_isUnDuckingInProgress', blank=True, null=True)
#     ctplayer_2_isunknown = Bit1BooleanField(db_column='ctPlayer_2_isUnknown', blank=True, null=True)
#     ctplayer_2_iswalking = Bit1BooleanField(db_column='ctPlayer_2_isWalking', blank=True, null=True)
#     ctplayer_2_lastplacename = models.TextField(db_column='ctPlayer_2_lastPlaceName', blank=True, null=True)
...
#     ctplayer_2_spotters = models.TextField(db_column='ctPlayer_2_spotters', blank=True, null=True)
...
#     ctplayer_3 = models.ForeignKey('Player', models.DO_NOTHING, db_column='ctPlayer_3_ID', blank=True, null=True)
...
#     ctplayer_3_cash = models.PositiveSmallIntegerField(db_column='ctPlayer_3_cash', blank=True, null=True)
#     ctplayer_3_cashspendthisround = models.PositiveSmallIntegerField(db_column='ctPlayer_3_cashSpendThisRound', blank=True, null=True)
#     ctplayer_3_cashspendtotal = models.PositiveIntegerField(db_column='ctPlayer_3_cashSpendTotal', blank=True, null=True)
#     ctplayer_3_equipmentvalue = models.PositiveSmallIntegerField(db_column='ctPlayer_3_equipmentValue', blank=True, null=True)
...
#     ctplayer_3_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='ctPlayer_3_equipmentValueRoundStart', blank=True, null=True)
...
#     ctplayer_3_isinbombzone = Bit1BooleanField(db_column='ctPlayer_3_isInBombZone', blank=True, null=True)
#     ctplayer_3_isinbuyzone = Bit1BooleanField(db_column='ctPlayer_3_isInBuyZone', blank=True, null=True)
...
#     ctplayer_3_isstanding = Bit1BooleanField(db_column='ctPlayer_3_isStanding', blank=True, null=True)
#     ctplayer_3_isunduckinginprogress = Bit1BooleanField(db_column='ctPlayer_3_isUnDuckingInProgress', blank=True, null=True)
#     ctplayer_3_isunknown = Bit1BooleanField(db_column='ctPlayer_3_isUnknown', blank=True, null=True)
#     ctplayer_3_iswalking = Bit1BooleanField(db_column='ctPlayer_3_isWalking', blank=True, null=True)
#     ctplayer_3_lastplacename = models.TextField(db_column='ctPlayer_3_lastPlaceName', blank=True, null=True)
...
#     ctplayer_3_spotters = models.TextField(db_column='ctPlayer_3_spotters', blank=True, null=True)
...
#     ctplayer_4 = models.ForeignKey('Player', models.DO_NOTHING, db_column='ctPlayer_4_ID', blank=True, null=True)
...
#     ctplayer_4_cash = models.PositiveSmallIntegerField(db_column='ctPlayer_4_cash', blank=True, null=True)
#     ctplayer_4_cashspendthisround = models.PositiveSmallIntegerField(db_column='ctPlayer_4_cashSpendThisRound', blank=True, null=True)
#     ctplayer_4_cashspendtotal = models.PositiveIntegerField(db_column='ctPlayer_4_cashSpendTotal', blank=True, null=True)
#     ctplayer_4_equipmentvalue = models.PositiveSmallIntegerField(db_column='ctPlayer_4_equipmentValue', blank=True, null=True)
...
#     ctplayer_4_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='ctPlayer_4_equipmentValueRoundStart', blank=True, null=True)
...
#     ctplayer_4_isinbombzone = Bit1BooleanField(db_column='ctPlayer_4_isInBombZone', blank=True, null=True)
#     ctplayer_4_isinbuyzone = Bit1BooleanField(db_column='ctPlayer_4_isInBuyZone', blank=True, null=True)
...
#     ctplayer_4_isstanding = Bit1BooleanField(db_column='ctPlayer_4_isStanding', blank=True, null=True)
#     ctplayer_4_isunduckinginprogress = Bit1BooleanField(db_column='ctPlayer_4_isUnDuckingInProgress', blank=True, null=True)
#     ctplayer_4_isunknown = Bit1BooleanField(db_column='ctPlayer_4_isUnknown', blank=True, null=True)
#     ctplayer_4_iswalking = Bit1BooleanField(db_column='ctPlayer_4_isWalking', blank=True, null=True)
#     ctplayer_4_lastplacename = models.TextField(db_column='ctPlayer_4_lastPlaceName', blank=True, null=True)
...
#     ctplayer_4_spotters = models.TextField(db_column='ctPlayer_4_spotters', blank=True, null=True)
...
#     ctplayer_5 = models.ForeignKey('Player', models.DO_NOTHING, db_column='ctPlayer_5_ID', blank=True, null=True)
...
#     ctplayer_5_cash = models.PositiveSmallIntegerField(db_column='ctPlayer_5_cash', blank=True, null=True)
#     ctplayer_5_cashspendthisround = models.PositiveSmallIntegerField(db_column='ctPlayer_5_cashSpendThisRound', blank=True, null=True)
#     ctplayer_5_cashspendtotal = models.PositiveIntegerField(db_column='ctPlayer_5_cashSpendTotal', blank=True, null=True)
#     ctplayer_5_equipmentvalue = models.PositiveSmallIntegerField(db_column='ctPlayer_5_equipmentValue', blank=True, null=True)
...
#     ctplayer_5_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='ctPlayer_5_equipmentValueRoundStart', blank=True, null=True)
...
#     ctplayer_5_isinbombzone = Bit1BooleanField(db_column='ctPlayer_5_isInBombZone', blank=True, null=True)
#     ctplayer_5_isinbuyzone = Bit1BooleanField(db_column='ctPlayer_5_isInBuyZone', blank=True, null=True)
...
#     ctplayer_5_isstanding = Bit1BooleanField(db_column='ctPlayer_5_isStanding', blank=True, null=True)
#     ctplayer_5_isunduckinginprogress = Bit1BooleanField(db_column='ctPlayer_5_isUnDuckingInProgress', blank=True, null=True)
#     ctplayer_5_isunknown = Bit1BooleanField(db_column='ctPlayer_5_isUnknown', blank=True, null=True)
#     ctplayer_5_iswalking = Bit1BooleanField(db_column='ctPlayer_5_isWalking', blank=True, null=True)
#     ctplayer_5_lastplacename = models.TextField(db_column='ctPlayer_5_lastPlaceName', blank=True, null=True)
...
#     ctplayer_5_spotters = models.TextField(db_column='ctPlayer_5_spotters', blank=True, null=True)
...
#     cttotalutility = models.IntegerField(db_column='ctTotalUtility', blank=True, null=True)
#     matchid = models.ForeignKey('Round', models.DO_NOTHING, db_column='matchID')
#     roundnum = models.ForeignKey('Round', models.DO_NOTHING, db_column='roundNum', blank=True, null=True)
#     seconds = models.FloatField(blank=True, null=True)
#     taliveplayers = models.IntegerField(db_column='tAlivePlayers', blank=True, null=True)
#     teqval = models.PositiveIntegerField(db_column='tEqVal', blank=True, null=True)
#     tname = models.TextField(db_column='tName', blank=True, null=True)
...
#     tplayer_1 = models.ForeignKey('Player', models.DO_NOTHING, db_column='tPlayer_1_ID', blank=True, null=True)
...
#     tplayer_1_cash = models.PositiveSmallIntegerField(db_column='tPlayer_1_cash', blank=True, null=True)
#     tplayer_1_cashspendthisround = models.PositiveSmallIntegerField(db_column='tPlayer_1_cashSpendThisRound', blank=True, null=True)
#     tplayer_1_cashspendtotal = models.PositiveIntegerField(db_column='tPlayer_1_cashSpendTotal', blank=True, null=True)
#     tplayer_1_equipmentvalue = models.PositiveSmallIntegerField(db_column='tPlayer_1_equipmentValue', blank=True, null=True)
...
#     tplayer_1_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='tPlayer_1_equipmentValueRoundStart', blank=True, null=True)
...
#     tplayer_1_isinbombzone = Bit1BooleanField(db_column='tPlayer_1_isInBombZone', blank=True, null=True)
#     tplayer_1_isinbuyzone = Bit1BooleanField(db_column='tPlayer_1_isInBuyZone', blank=True, null=True)
...
#     tplayer_1_isstanding = Bit1BooleanField(db_column='tPlayer_1_isStanding', blank=True, null=True)
#     tplayer_1_isunduckinginprogress = Bit1BooleanField(db_column='tPlayer_1_isUnDuckingInProgress', blank=True, null=True)
#     tplayer_1_isunknown = Bit1BooleanField(db_column='tPlayer_1_isUnknown', blank=True, null=True)
#     tplayer_1_iswalking = Bit1BooleanField(db_column='tPlayer_1_isWalking', blank=True, null=True)
#     tplayer_1_lastplacename = models.TextField(db_column='tPlayer_1_lastPlaceName', blank=True, null=True)
...
#     tplayer_1_spotters = models.TextField(db_column='tPlayer_1_spotters', blank=True, null=True)
...
#     tplayer_2 = models.ForeignKey('Player', models.DO_NOTHING, db_column='tPlayer_2_ID', blank=True, null=True)
...
#     tplayer_2_cash = models.PositiveSmallIntegerField(db_column='tPlayer_2_cash', blank=True, null=True)
#     tplayer_2_cashspendthisround = models.PositiveSmallIntegerField(db_column='tPlayer_2_cashSpendThisRound', blank=True, null=True)
#     tplayer_2_cashspendtotal = models.PositiveIntegerField(db_column='tPlayer_2_cashSpendTotal', blank=True, null=True)
#     tplayer_2_equipmentvalue = models.PositiveSmallIntegerField(db_column='tPlayer_2_equipmentValue', blank=True, null=True)
...
#     tplayer_2_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='tPlayer_2_equipmentValueRoundStart', blank=True, null=True)
...
#     tplayer_2_isinbombzone = Bit1BooleanField(db_column='tPlayer_2_isInBombZone', blank=True, null=True)
#     tplayer_2_isinbuyzone = Bit1BooleanField(db_column='tPlayer_2_isInBuyZone', blank=True, null=True)
...
#     tplayer_2_isstanding = Bit1BooleanField(db_column='tPlayer_2_isStanding', blank=True, null=True)
#     tplayer_2_isunduckinginprogress = Bit1BooleanField(db_column='tPlayer_2_isUnDuckingInProgress', blank=True, null=True)
#     tplayer_2_isunknown = Bit1BooleanField(db_column='tPlayer_2_isUnknown', blank=True, null=True)
#     tplayer_2_iswalking = Bit1BooleanField(db_column='tPlayer_2_isWalking', blank=True, null=True)
#     tplayer_2_lastplacename = models.TextField(db_column='tPlayer_2_lastPlaceName', blank=True, null=True)
...
#     tplayer_2_spotters = models.TextField(db_column='tPlayer_2_spotters', blank=True, null=True)
...
#     tplayer_3 = models.ForeignKey('Player', models.DO_NOTHING, db_column='tPlayer_3_ID', blank=True, null=True)
...
#     tplayer_3_cash = models.PositiveSmallIntegerField(db_column='tPlayer_3_cash', blank=True, null=True)
#     tplayer_3_cashspendthisround = models.PositiveSmallIntegerField(db_column='tPlayer_3_cashSpendThisRound', blank=True, null=True)
#     tplayer_3_cashspendtotal = models.PositiveIntegerField(db_column='tPlayer_3_cashSpendTotal', blank=True, null=True)
#     tplayer_3_equipmentvalue = models.PositiveSmallIntegerField(db_column='tPlayer_3_equipmentValue', blank=True, null=True)
...
#     tplayer_3_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='tPlayer_3_equipmentValueRoundStart', blank=True, null=True)
...
#     tplayer_3_isinbombzone = Bit1BooleanField(db_column='tPlayer_3_isInBombZone', blank=True, null=True)
#     tplayer_3_isinbuyzone = Bit1BooleanField(db_column='tPlayer_3_isInBuyZone', blank=True, null=True)
...
#     tplayer_3_isstanding = Bit1BooleanField(db_column='tPlayer_3_isStanding', blank=True, null=True)
#     tplayer_3_isunduckinginprogress = Bit1BooleanField(db_column='tPlayer_3_isUnDuckingInProgress', blank=True, null=True)
#     tplayer_3_isunknown = Bit1BooleanField(db_column='tPlayer_3_isUnknown', blank=True, null=True)
#     tplayer_3_iswalking = Bit1BooleanField(db_column='tPlayer_3_isWalking', blank=True, null=True)
#     tplayer_3_lastplacename = models.TextField(db_column='tPlayer_3_lastPlaceName', blank=True, null=True)
...
#     tplayer_3_spotters = models.TextField(db_column='tPlayer_3_spotters', blank=True, null=True)
...
#     tplayer_4 = models.ForeignKey('Player', models.DO_NOTHING, db_column='tPlayer_4_ID', blank=True, null=True)
...
#     tplayer_4_cash = models.PositiveSmallIntegerField(db_column='tPlayer_4_cash', blank=True, null=True)
#     tplayer_4_cashspendthisround = models.PositiveSmallIntegerField(db_column='tPlayer_4_cashSpendThisRound', blank=True, null=True)
#     tplayer_4_cashspendtotal = models.PositiveIntegerField(db_column='tPlayer_4_cashSpendTotal', blank=True, null=True)
#     tplayer_4_equipmentvalue = models.PositiveSmallIntegerField(db_column='tPlayer_4_equipmentValue', blank=True, null=True)
...
#     tplayer_4_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='tPlayer_4_equipmentValueRoundStart', blank=True, null=True)
...
#     tplayer_4_isinbombzone = Bit1BooleanField(db_column='tPlayer_4_isInBombZone', blank=True, null=True)
#     tplayer_4_isinbuyzone = Bit1BooleanField(db_column='tPlayer_4_isInBuyZone', blank=True, null=True)
...
#     tplayer_4_isstanding = Bit1BooleanField(db_column='tPlayer_4_isStanding', blank=True, null=True)
#     tplayer_4_isunduckinginprogress = Bit1BooleanField(db_column='tPlayer_4_isUnDuckingInProgress', blank=True, null=True)
#     tplayer_4_isunknown = Bit1BooleanField(db_column='tPlayer_4_isUnknown', blank=True, null=True)
#     tplayer_4_iswalking = Bit1BooleanField(db_column='tPlayer_4_isWalking', blank=True, null=True)
#     tplayer_4_lastplacename = models.TextField(db_column='tPlayer_4_lastPlaceName', blank=True, null=True)
...
#     tplayer_4_spotters = models.TextField(db_column='tPlayer_4_spotters', blank=True, null=True)
...
#     tplayer_5 = models.ForeignKey('Player', models.DO_NOTHING, db_column='tPlayer_5_ID', blank=True, null=True)
...
#     tplayer_5_cash = models.PositiveSmallIntegerField(db_column='tPlayer_5_cash', blank=True, null=True)
#     tplayer_5_cashspendthisround = models.PositiveSmallIntegerField(db_column='tPlayer_5_cashSpendThisRound', blank=True, null=True)
#     tplayer_5_cashspendtotal = models.PositiveIntegerField(db_column='tPlayer_5_cashSpendTotal', blank=True, null=True)
#     tplayer_5_equipmentvalue = models.PositiveSmallIntegerField(db_column='tPlayer_5_equipmentValue', blank=True, null=True)
...
#     tplayer_5_equipmentvalueroundstart = models.PositiveSmallIntegerField(db_column='tPlayer_5_equipmentValueRoundStart', blank=True, null=True)
...
#     tplayer_5_isinbombzone = Bit1BooleanField(db_column='tPlayer_5_isInBombZone', blank=True, null=True)
#     tplayer_5_isinbuyzone = Bit1BooleanField(db_column='tPlayer_5_isInBuyZone', blank=True, null=True)
...
#     tplayer_5_isstanding = Bit1BooleanField(db_column='tPlayer_5_isStanding', blank=True, null=True)
#     tplayer_5_isunduckinginprogress = Bit1BooleanField(db_column='tPlayer_5_isUnDuckingInProgress', blank=True, null=True)
#     tplayer_5_isunknown = Bit1BooleanField(db_column='tPlayer_5_isUnknown', blank=True, null=True)
#     tplayer_5_iswalking = Bit1BooleanField(db_column='tPlayer_5_isWalking', blank=True, null=True)
#     tplayer_5_lastplacename = models.TextField(db_column='tPlayer_5_lastPlaceName', blank=True, null=True)
...
#     tplayer_5_spotters = models.TextField(db_column='tPlayer_5_spotters', blank=True, null=True)
...
#     ttotalutility = models.IntegerField(db_column='tTotalUtility', blank=True, null=True)
#     tick = models.PositiveIntegerField()
#
#     class Meta:
#         managed = False
...
#     parsedmatchid = models.TextField(db_column='parsedMatchID', blank=True, null=True)
